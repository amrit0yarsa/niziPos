...
#define ST7789_240x320_XSTART 0
#define ST7789_240x320_YSTART 0
...
class Arduino_ST7789 {
 ...
 public:
  ...
  Arduino_ST7789(int8_t dc, int8_t rst, int8_t cs, SPIClass *spiClass);

void setAddrWindow(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1);
  void pushColor(uint16_t color);
  void pushData(uint16_t color);
  void pushDataMultiple(uint16_t *color, size_t size);
  void startWrite();
  void endWrite();
